...
class StoreEspeceParametreRequest extends FormRequest
{
    ...
    {
        return [
            'duree_gestation_jours'    => 'nullable|integer|min:1',
            'age_reproduction_mois'    => 'nullable|integer|min:1',
            'nombre_petits_typique'    => 'nullable|integer|min:1',
            'intervalle_vaccin_jours'  => 'nullable|integer|min:1',
            'age_sevrage_jours'        => 'nullable|integer|min:1',
            'poids_naissance_moyen_kg' => 'nullable|numeric|min:0',
            'poids_adulte_moyen_kg'    => 'nullable|numeric|min:0',
        ];
    }
