...
@push('styles')
    <link rel="stylesheet" href="{{ asset('admin/css/sante-rappels/edit.css') }}">
@endpush
    ...
    <form id="rappel-edit-form"
        ...
        <div class="form-section">
            <div class="form-section-header">
                ...
                <h3>Modifier le rappel sanitaire</h3>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <select id="type"
                                    ...
                                    <option value="VACCINATION" {{ old('type', $rappel['type'] ?? '') === 'VACCINATION' ? 'selected' : '' }}>Vaccination</option>
                                    <option value="TRAITEMENT" {{ old('type', $rappel['type'] ?? '') === 'TRAITEMENT' ? 'selected' : '' }}>Traitement</option>
                                    <option value="CONTROLE" {{ old('type', $rappel['type'] ?? '') === 'CONTROLE' ? 'selected' : '' }}>Contrôle</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <input type="date"
                                       ...
                                       value="{{ old('date_prevue', $rappel['date_prevue'] ?? '') }}"
                                       required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <select id="statut"
                                    ...
                                    <option value="EN_ATTENTE" {{ old('statut', $rappel['statut'] ?? '') === 'EN_ATTENTE' ? 'selected' : '' }}>En attente</option>
                                    <option value="EFFECTUE" {{ old('statut', $rappel['statut'] ?? '') === 'EFFECTUE' ? 'selected' : '' }}>Effectué</option>
                                    <option value="EN_RETARD" {{ old('statut', $rappel['statut'] ?? '') === 'EN_RETARD' ? 'selected' : '' }}>En retard</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <input type="text"
                                       ...
                                       value="{{ old('produit_utilise', $rappel['produit_utilise'] ?? '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <input type="text"
                                       ...
                                       value="{{ old('veterinaire', $rappel['veterinaire'] ?? '') }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="description"
                                      ...
                                      rows="3"
                                      placeholder="Description du rappel...">{{ old('description', $rappel['description'] ?? '') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
...
@push('scripts')
    <script src="{{ asset('admin/js/sante-rappels/edit.js') }}"></script>
@endpush
