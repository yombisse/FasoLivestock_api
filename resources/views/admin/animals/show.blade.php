...
@section('content')
<div x-data="animalShow()" class="fade-in">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="field">
                        ...
                        <div class="value fw-semibold text-dark">{{ $animal['nom'] ?? '—' }}</div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="field">
                        ...
                        <div class="value fw-semibold text-dark">{{ $animal['numero_identification'] ?? '—' }}</div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="field">
                        ...
                        <div class="value fw-semibold text-dark">{{ $animal['race'] ?? '—' }}</div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="field">
                        ...
                        <div class="value fw-semibold text-dark">{{ $animal['poids'] ?? '—' }}</div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="field">
                        ...
                        <div class="value fw-semibold text-dark">{{ $animal['farm']['name'] ?? '—' }}</div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="field">
                        ...
                        <div class="value fw-semibold text-dark">{{ $animal['espece']['nom'] ?? '—' }}</div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="field">
                        ...
                        <div class="value fw-semibold text-dark">{{ $animal['lot']['nom'] ?? '—' }}</div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="field">
                        ...
                        <div class="value fw-semibold text-dark">{{ $animal['mother']['nom'] ?? '—' }}</div>
                    </div>
                </div>
